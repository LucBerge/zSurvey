...
@CommandInfo (name = "removeanswer", usageParameters = "<name> <question_number> <answer_number>")
public class RemoveAnswerCommand extends zSurveyCommands{
    ...
    protected void run() throws CommandException {
        ...
        try {
        	zSurvey.removeAnswer(playerSender(), name, question_number, answer_number);
